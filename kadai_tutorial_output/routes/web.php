...
/*本教材ではLaravel Breezeが生成したダッシュボードや会員編集ページは利用しないため（下記のコメントアウトしている部分）、これらの不要なルーティングをコメントアウトしている*/
/*
...
Route::destroy('/posts/{post}', [PostController::class, 'destroy'])->middleware(['auth', 'verified'])->name('posts.destroy');
*/
