...
class PostTest extends TestCase
{
    use RefreshDatabase;
     ...
     public function test_uesr_cannot_access_others_posts_edit(){
        $user = User::factory()->create();
     ...
     public function test_user_cannot_update_others_post(){
         $user = User::factory()->create();
         $other_user = User::factory()->create();
         $other_old_post = Post::factory()->create(['user_id' => $other_user]);
        ...
        $response = $this->actingAs($user)->patch(route('posts.update', $other_old_post), $new_post);
        $this->assertDatabaseMissing('posts', $new_post);
        $response->assertRedirect(route('posts.index'));
     }
